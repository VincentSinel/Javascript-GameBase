class UI_ViewPort extends UI_Element
{
     ...
     * @type {float}
     */
    CX(sender) { return -this.ViewportX + super.CX(sender); }
    /**
     * Calcul la position Y de point de départ d'un contenue d'objet (padding)
     * @type {float}
     */
    CY(sender) { return -this.ViewportY + super.CY(sender); }
    ...
    Set_FinalContentSize(Size) { super.Set_FinalContentSize(this.Desiredsize); }
