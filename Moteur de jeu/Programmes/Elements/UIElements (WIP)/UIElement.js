class UIElement
{
    ...
    constructor(X,Y,W,H, Parent = undefined)
    {
        ...
        this.onSouris_AuDessus = function(e){};
        this.onSouris_Entre = function(e){};
        this.onSouris_Quitte = function(e){};
        this.onSouris_Clique = function(e){};
        this.onSouris_Scroll = function(e){};
        this.onFocus_Gain = function(e){};
        this.onFocus_Perte = function(e){};
        this.onClavier_ToucheJusteBasse = function(e){};
        this.onClavier_ToucheJusteHaute = function(e){};
        this.onClavier_ToucheBasse = function(e){};
    }

    #SourisEntre()
    {
        this.onSouris_Entre(new UIEvenement(UIEvenementType.Souris_Entre, this))
    }
    ...
    {
        if (this.Parent)
            return this.Z + this.Parent.GZ(souris);
        else
            return this.Z;
    }
    ...
    Dessin(Context)
    {
        let tempctx = CreateCanvas();
        this.DessinUI(tempctx)
        for (let e = this.Enfants.length - 1; e >= 0; e--) {
            this.Enfants[e].Dessin(tempctx);
        }

        Context.drawImage(tempctx, this.X, this.Y)
    }
    ...
    CreateCanvas()
    {
        let tempctx = document.createElement("canvas").getContext("2d"); // Création d'un canvas temporaire
        tempctx.canvas.width = this.W; // Modification taille
        tempctx.canvas.height = this.H; // Modification taille
    }
...
class UIEvenementType {
    ...
    static Souris_AuDessus = new Season("Souris_AuDessus")
    static Souris_Entre = new Season("Souris_Entre")
    static Souris_Quitte = new Season("Souris_Quitte")
    static Souris_Clique = new Season("Souris_Clique")
    static Souris_Scroll = new Season("Souris_Scroll")
    static Focus_Gain = new Season("Focus_Gain")
    static Focus_Perte = new Season("Focus_Perte")
    static Clavier_ToucheJusteBasse = new Season("Clavier_ToucheJusteBasse")
    static Clavier_ToucheJusteHaute = new Season("Clavier_ToucheJusteHaute")
    static Clavier_ToucheBasse = new Season("Clavier_ToucheBasse")
...
{
    static Gauche = new HorizontalAlignementType("Gauche");
    static Centre = new HorizontalAlignementType("Centre");
    static Droite = new HorizontalAlignementType("Droite");
    static Etendu = new HorizontalAlignementType("Etendu");
    constructor(name)
    {
        this.Name = name;
    }
